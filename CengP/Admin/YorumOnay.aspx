<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="YorumOnay.aspx.cs" Inherits="Admin_YorumOnay" %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Yorum Onayla</li>
                </ol>
            </section>
            <!-- Main content -->
            <br />
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Onaysız Yorumlar</h3>
                            </div>
                            <br />
                            <div align="center">
