<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="OnaysizKullanici.aspx.cs" Inherits="Admin_OnaysizKullanici" %>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Onaysız Kullanıcılar</h3>
                            </div>
                            <br />
                            <div class="col-md-3">
                            ...
                            <div align="center">
                                <asp:GridView runat="server" ID="datagridview" CssClass="mydatagrid" AllowPaging="True"
                                    ...
                                    <Columns>
                                        <asp:ButtonField ButtonType="Button" Text="Onayla" CommandName="Update"
                                            ControlStyle-BackColor="#507CD1" ControlStyle-ForeColor="White" ControlStyle-Font-Size="15px" />
                                    </Columns>
