<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="YazarOnay.aspx.cs" Inherits="Admin_YazarOnay" %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Yazar Onayla</li>
                </ol>
            </section>
            <br />
            <!-- Main content -->
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Onaysız Yazarlar</h3>
                            </div>
                            <br />
                            <div class="col-md-3">
