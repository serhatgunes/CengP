...
<body>
    <form id="form1" runat="server">
                ...
                <div class="isotopeFilters">
                    <ul class="gallery-filter clearfix">
                        ...
                        <asp:ListView ID="ListView2" runat="server">
                            <ItemTemplate>
                                <li><a href="#" data-filter=".<%#Eval("coursename") %>"><%#Eval("coursename") %></a></li>
                            </ItemTemplate>
                        </asp:ListView>
                    </ul>
                </div>
        ...
        <section class="news-wrapper">
            <br />
            <div class="container">
                <ul class="row news-listing gallery clearfix isotopeContainer">

                    <asp:ListView ID="ListView1" runat="server">
                        <ItemTemplate>
                            <li class="isotopeSelector col-xs-6 col-sm-3 grid-item <%#Eval("coursename") %>">
