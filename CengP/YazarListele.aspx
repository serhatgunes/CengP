<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YazarListele.aspx.cs" Inherits="YazarListele" %>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-9">
                        <div class="contact clearfix">
                            <ul class="hidden-xs">
                                <li><span>Email</span> <a href="mailto:info@edumart.org">info@cengp.org</a> </li>
                            </ul>
                            <a href="Account/Register.aspx" class="login">Kayıt Ol <span class="icon-more-icon"></span></a>
                            <a href="Account/Login.aspx" class="login">Giriş Yap <span class="icon-more-icon"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse" id="navbar">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown"><a data-toggle="dropdown" href="#">Kategorİler <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="Account/Login.aspx">Java</a></li>
                                    <li><a href="Account/Login.aspx">.NET</a></li>
                                    <li><a href="Account/Login.aspx">Android Studio</a></li>
                                    <li><a href="Account/Login.aspx">IOS</a></li>
                                    <li><a href="Account/Login.aspx">Microsoft SQL Server</a></li>
                                    <li><a href="Account/Login.aspx">Bilgisayar Mühendisliği</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a data-toggle="dropdown" href="#">Onlİne Testler <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="Account/Login.aspx">Java</a></li>
                                    <li><a href="Account/Login.aspx">.NET</a></li>
                                    <li><a href="Account/Login.aspx">Android Studio</a></li>
                            ...
                            <li><a href="YazarListele.aspx">Yazarlar</a></li>
